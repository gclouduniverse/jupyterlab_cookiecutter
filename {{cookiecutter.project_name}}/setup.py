...
tar_path = pjoin(here, '{{cookiecutter.project_name}}*.tgz')
...
def get_data_files():
    ...
    return [
        ...
        ('etc/jupyter/jupyter_notebook_config.d', [
          'jupyter-config/jupyter_notebook_config.d/{{cookiecutter.project_name}}.json'
        ])
    ]
...
class NPM(Command):
    ...
    def run(self):
        ...
        if self.should_run_npm_pack():
            log.info("Packing {{cookiecutter.project_name}} into archive")
