  ...
  render() {
    ...
    return (
      <div className={localStyles.panel}>
        <header className={localStyles.header}>{{cookiecutter.settings_title}}</header>
        {isLoading ? (
          <LinearProgress />
        ) : (
...
export class ListWordsWidget extends ReactWidget {
  ...
  constructor(private readonly listWordsService: ListWordsService) {
    super();
    this.title.iconClass = 'jp-Icon jp-Icon-20 {{cookiecutter.settings_icon_class}}';
    this.title.caption = '{{cookiecutter.settings_title}}';
  }
